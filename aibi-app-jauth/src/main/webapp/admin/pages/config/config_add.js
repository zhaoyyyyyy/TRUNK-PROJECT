	...
	if(true){//开始写HTML
		...
		if(1==obj.length){//如果fields只有1个
			...
			html+=
				...
				+'<p v-if="\'enum\'==\''+obj[0].type+'\'"><v-input id="configVal" name="configVal" defValue="configVal" type="text" class="inputStyle_300 easyui-validatebox" required="true" datadic="ALL" ></v-input><input name="configValType" type="hidden" value="3" /></p>'
				+'<p v-if="\'driver\'==\''+obj[0].type+'\'"><v-input id="configVal" name="configVal" defValue="configVal" type="text" class="inputStyle_300 easyui-validatebox" required="true" datadic="'+obj[0].dimCode+'" ></v-input><input name="configValType" type="hidden" value="4" /></p>'
				+'<p v-if="\'text\'==\''+obj[0].type+'\'"><v-input id="configVal" name="configVal" defValue="configVal" type="text" class="inputStyle_300 easyui-validatebox"  required="true" ></v-input><input name="configValType" type="hidden" value="2" /></p>'
				+'<p v-if="\'boolean\'==\''+obj[0].type+'\'"><v-input id="configVal" name="configVal" defValue="configVal" type="text" class="inputStyle_300 easyui-validatebox"  required="true" datadic="TOF"></v-input><input name="configValType" type="hidden" value="2" /></p>'
				+'<p v-if="\'catalog\'==\''+obj[0].type+'\'"><v-input id="configVal" name="configVal" defValue="configVal" type="text" class="inputStyle_300 easyui-validatebox"  required="true" ></v-input><input name="configValType" type="hidden" value="1" /> </p>'
				+'</td>';
			html+='</tr><tr>';
			...
			for(var i=0;i<obj.length;i++){
				...
				html+=
					...
					+'<p v-if="\'enum\'==\''+obj[i].type+'\'"><v-input id="configVal"name="configVal" defValue="configVal" type="text" class="inputStyle_300 easyui-validatebox" required="true" datadic="'+obj[i].dimCode+'"></v-input><input name="configValTypes" type="hidden" value="5" /></p>'
					+'<p v-if="\'text\'==\''+obj[i].type+'\'"><v-input id="configVal"name="configVal" defValue="configVal" type="text" class="inputStyle_300 easyui-validatebox" required="true"></v-input><input name="configValTypes" type="hidden" value="3" /></p>'
					+'<p v-if="\'boolean\'==\''+obj[i].type+'\'"><v-input id="configVal"name="configVal" defValue="configVal" type="text" class="inputStyle_300 easyui-validatebox"  required="true" datadic="TOF"></v-input><input name="configValTypes" type="hidden" value="2" /></p>'
					+'</td>';
				html+='</tr><tr>';
