	...
	if(true){//开始写HTML
		...
		if(1==obj.length){//如果fields只有1个
			...
			html+=
				...
				+'<p v-if="\'enum\'==\''+obj[0].type+'\'"><v-input id="configVal" name="configVal" defValue="configVal" type="text" class="inputStyle easyui-validatebox" required="true" datadic="ALL" ></v-input><input name="configValType" type="hidden" value="3" /></p>'
				+'<p v-if="\'driver\'==\''+obj[0].type+'\'"><v-input id="configVal" name="configVal" defValue="configVal" type="text" class="inputStyle easyui-validatebox" required="true" datadic="'+obj[0].dimCode+'" ></v-input><input name="configValType" type="hidden" value="4" /></p>'
			...
			for(var i=0;i<obj.length;i++){
				...
				html+=
					...
					+'<p v-if="\'text\'==\''+obj[i].type+'\'"><v-input id="configVal"name="configVal" defValue="configVal" type="text" class="inputStyle easyui-validatebox" required="true"></v-input><input name="configValTypes" type="hidden" value="2" /></p>'
					+'<p v-if="\'boolean\'==\''+obj[i].type+'\'"><v-input id="configVal"name="configVal" defValue="configVal" type="text" class="inputStyle easyui-validatebox"  required="true" datadic="TOF"></v-input><input name="configValTypes" type="hidden" value="1" /></p>'
					+'</td>';
				html+='</tr><tr>';
