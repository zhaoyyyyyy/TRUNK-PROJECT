...
function() {
    ...
    function Ue(e, n, r, i, o) {
        ...
        return f instanceof ho && (f.functionalContext = i, r.slot && ((f.data || (f.data = {})).slot = r.slot)),
        f
    }
    function Ve(e, t) {
    ...
    function Ye(n, r) {
        if (n.ns = r, "foreignObject" !== n.tag && Array.isArray(n.children)) for (var i = 0,
    ...
    function qn(n, r) {
        ...
        if (!e(a) && !t(o._enterCb) && 1 === o.nodeType) {
            ...
            A = s.duration,
            O = bo,
            S = bo.$vnode; S && S.parent;) S = S.parent,
            O = S.context;
